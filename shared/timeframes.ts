...
export const TIMEFRAME_DEFINITIONS: TimeframeDefinition[] = [
  { key: '1m', label: '1m', apiBar: '1m', minutes: 1, sortOrder: 0 },
  { key: '5m', label: '5m', apiBar: '5m', minutes: 5, sortOrder: 1 },
  {
    key: '10m',
    label: '10m',
    apiBar: '5m',
  ...
  { key: '15m', label: '15m', apiBar: '15m', minutes: 15, sortOrder: 3 },
  { key: '30m', label: '30m', apiBar: '30m', minutes: 30, sortOrder: 4 },
  { key: '1H', label: '1H', apiBar: '1h', minutes: 60, sortOrder: 5 },
  {
    key: '2H',
    label: '2H',
    apiBar: '1h',
  ...
  { key: '4H', label: '4H', apiBar: '4h', minutes: 240, sortOrder: 8 },
  {
    key: '8H',
    label: '8H',
    apiBar: '8h',
  ...
  { key: '1D', label: '1D', apiBar: '1d', minutes: 1440, sortOrder: 11 },
  {
    key: '2D',
    label: '2D',
    apiBar: '1d',
